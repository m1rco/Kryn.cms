ka.widget = new Class({
    ...
    loadWindow: function(){
        ...
        this.main = new Element('div', {
            'class': 'ka-widget-main'+((this.asOverview)?' ka-widget-overview':''),
            style: 'height: 150px;'
        ...
        this.content = new Element('div', {
            ...
            html: '<center><img src="'+_path+'inc/template/admin/images/ka-tooltip-loading.gif" /></center>'
        }).inject( this.main );
        
        this.bottom = new Element('div', {
            'class': 'ka-widget-bottom'
        }).inject( this.main );
    ...
    load: function(){
        ...
        if( this.opts.type == 'custom' ){
            ...
            this.table = new ka.Table(columns).inject( this.content );
    ...
    initNoneDesktop: function(){
        ...
        .addEvent('click', function(){
            ka._desktop.addWidget( this.opts );
        }.bind(this))
        .inject( this.main );
