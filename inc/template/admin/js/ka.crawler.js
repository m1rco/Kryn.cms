ka.crawler = new Class({
    ...
    step1: function(){
        ...
        this.lastRq = new Request.JSON({url: _path+'admin/backend/searchIndexer/getWaitlist', noCache: 1,
    ...
    step1_5: function(){
        ...
        this.lastRq = new Request.JSON({url: _path+'admin/backend/searchIndexer/getNewUnindexedPages', noCache: 1,
            onComplete: function(pRes){
                if( pRes.access == false ) return this.restart();
    ...
    step2: function(){
        ...
        this.lastRq = new Request.JSON({url: _path+'admin/backend/searchIndexer/getIndex', noCache: 1,
        onComplete: function(pRes){
            if( pRes.access == false ) return this.restart();
