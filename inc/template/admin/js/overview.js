admin_overview = new Class({
    initialize: function( pWindow ){
        ...
        //this.buttons['general'] = this.topGroup.addButton(_('General'), _path+'inc/template/admin/images/admin-pages-viewType-general.png', this.viewType.bind(this,'general'));
        //this.buttons['system'] = this.topGroup.addButton(_('System'), _path+'inc/template/admin/images/icons/computer.png', this.viewType.bind(this,'system'));
        //this.buttons['statistic'] = this.topGroup.addButton(_('Statistic'), _path+'inc/template/admin/images/icons/chart_pie.png', this.viewType.bind(this,'statistic'));
    ...
    viewType222: function( pType ){
        ...
        switch( pType ){
            case 'general': this.loadWidgets('overview'); break;
            case 'statistic': this.loadWidgets('statistic'); break;
        }
    },
